...
!function () {
    ...
    (function () {
        function X(e) {
            ...
            var Y = x.addEventListener, m = !1, C = !0, t = Y ? "addEventListener" : "attachEvent",
                z = Y ? "removeEventListener" : "detachEvent", i = Y ? "" : "on";
        ...
        A.push("/wp-content/themes/runoob/assets/js/hl/prettify.css");
        (function (e) {
            function j(m) {
                if (m !== w) {
            ...
            (function () {
                function j(a) {
                    ...
                    for (var j = 0, F = !1, l = !1, I = 0, c = a.length; I < c; ++I) {
                        var p = a[I];
                        if (p.ignoreCase) l =
                            !0; else if (/[a-z]/i.test(p.source.replace(/\\u[\da-f]{4}|\\x[\da-f]{2}|\\[^UXux]/gi, ""))) {
                            F = !0;
                            l = !1;
                            break
                        }
                ...
                function D(a) {
                    ...
                    try {
                        ...
                        var e = /\bMSIE\s(\d+)/.exec(navigator.userAgent), e = e && +e[1] <= 8, d = /\n/g, i = a.a,
                            j = i.length, h = 0, l = a.d, n = l.length, b = 0, c = a.g, p = c.length, t = 0;
                        c[p] = j;
                        var q, f;
                ...
                var V = window, G = ["break,continue,do,else,for,if,return,while"],
                    O = [[G, "auto,case,char,const,default,double,enum,extern,float,goto,inline,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"],
                ...
                var X = V.PR = {
                    ...
                    prettyPrint: e = e = function (a, d) {
                            ...
                            for (var b = V.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : Infinity; p < j.length && c.now() < b; p++) {
                                ...
                                if ((m !== k || f.test(l)) && !w.test(l)) {
                                    ...
                                    if (!n) {
                                        ...
                                        if (y.test(d.tagName)) s = 1; else var s = d.currentStyle, v = i.defaultView,
                        ...
                        var p = 0, t, q = /\blang(?:uage)?-([\w.]+)(?!\S)/, f = /\bprettyprint\b/,
                            w = /\bprettyprinted\b/, y = /pre|xmp/i, u = /^code$/i, g = /^(?:pre|code|xmp)$/i, k = {};
                        e()
                    }
                };
